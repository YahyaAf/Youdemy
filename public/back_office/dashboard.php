<?php
  ...
  require_once __DIR__ . '/../../vendor/autoload.php';
    ...
    $coursPlusEtudiant = $cours->getCoursesWithMostStudents();
    $getTopEnseignant = $cours->getTopEnseignant();
?>
<!DOCTYPE html>
<html lang="en">
      ...
      <div class="content">
        <div class="row">
          ...
          <div class="col-lg-4 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Global Etudiants</h5>
                <h4 class="card-title">Total Etudiant By Cours</h4>
              </div>
              <div class="card-body">
                <div class="card-category">
                  <?php foreach($coursPlusEtudiant as $plus): ?>
                      <p>- <?php echo $plus['title']; ?> : <?php echo $plus['student_count']; ?></p>
                  <?php endforeach; ?>
                </div>
              </div>
              <div class="card-footer">
                <div class="stats">
                  <i class="now-ui-icons ui-2_time-alarm"></i> Statistique
                </div>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6">
            <div class="card card-chart">
              <div class="card-header">
                <h5 class="card-category">Global Enseignant</h5>
                <h4 class="card-title">Top 3 d'enseignant</h4>
              </div>
              <div class="card-body">
                <div class="card-category">
                  <?php foreach($getTopEnseignant as $top): ?>
                      <p>- <?php echo $top['teacher_name']; ?> : <?php echo $top['student_count']; ?></p>
                  <?php endforeach; ?>
                </div>
              </div>
              <div class="card-footer">
