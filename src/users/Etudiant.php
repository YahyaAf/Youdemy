...
class Etudiant extends User {
    ...
    public function __construct($db, $username, $password, $email, $profile_picture_url) {
        parent::__construct($db, $username, $password, $email, 'etudiant');
    ...
    public function register() {
        ...
        $sql = "INSERT INTO users (username, email, password_hash, activation, role, profile_picture_url) 
                VALUES (:username, :email, :password_hash, 'accepted', 'etudiant', :profile_picture_url)";
    ...
    public function login() {
        $sql = "SELECT * FROM users WHERE (username = :username OR email = :email) AND role = 'etudiant'";
